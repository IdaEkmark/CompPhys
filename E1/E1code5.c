...
int main()
{
    ...
    saveQVtoFile("6/E1u6_dt2.5e4.csv", time_array, Q, V, n_t, n_p);
     ...
     */
    write_to_file("6/E1u6_PS_q1_dt2.5e4.csv", fftd_data1, frequencies, n_t);
	write_to_file("6/E1u6_PS_q2_dt2.5e4.csv", fftd_data2, frequencies, n_t);
	write_to_file("6/E1u6_PS_q3_dt2.5e4.csv", fftd_data3, frequencies, n_t);
	...
	saveEKPtoFile("6/E1u6_Energies_dt2.5e4.csv", time_array, E, K, P, n_t);
