 ...
 * clang E1code3.c fft.o -o ./Executable_files/<execuutable name> -lgsl -lgslcblas
 */
...
int main(int argc, char **argv)
{
    ...
    read_data("signal26.csv", time_array, signal);
    ...
    for(int i = 0; i < N_POINTS; i++){
	    frequencies[i] = i / (dt * N_POINTS) - 1.0 / (2.0 * dt);
    }
     ...
     */
    write_to_file("powerspectrum26.csv", fftd_data, frequencies, N_POINTS);
    return 0;
}
